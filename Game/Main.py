...
################### Level Manager ###################
# Generate world
world_width = screen_width*2   # width of: rows in a scene, scenelists in a world
world_height = screen_height*2  # number of: rows in a scene, scenelists in a world
tile_count = 100
...
################## Setup character ##################
player_start_pos = (world_width/2,world_height/2) ; player_speed = 1.5
